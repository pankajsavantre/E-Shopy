...
$pro=$_POST['pro'];
$sql="SELECT * FROM e_products WHERE p_name Like '%{$pro}%'";
...
if(mysqli_num_rows($result) > 0)
{
    ...
    <div class="card-header bg-warning text-center mx-auto">
        <h4 class="text-center">Product Not Available <i class="fa fa-database"></i> </h4>
    </div>
